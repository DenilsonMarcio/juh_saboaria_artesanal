...
describe('<Banner />', () => {
  it('should render correctly', () => {
    ...
    expect(
      screen.getByRole('heading', { name: /Sabonete Morango/i })
    ).toBeInTheDocument()
    // verifique se o sibtulo existe renderizado
    expect(
      screen.getByRole('heading', { name: /Morango Silvestre com pêra/i })
    ).toBeInTheDocument()
    // verifique se a imagem existe renderizado
    expect(
      screen.getByRole('img', { name: /Sabonete Morango/i })
    ).toBeInTheDocument()
