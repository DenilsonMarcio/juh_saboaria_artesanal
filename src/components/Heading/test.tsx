...
describe('<Heading />', () => {
  ...
  it('should render a black heading when color is passed', () => {
    ...
    it('should render a heading with a line to the left side', () => {
      ...
      expect(screen.getByRole('heading', {name: /Juju Soap/i})).toHaveStyle({'borderLeft': "0.7rem solid #F231A5"})
      })
    ...
    it('should render a heading with a small size', () => {
      ...
      expect(screen.getByRole('heading', {name: /Juju Soap/i})).toHaveStyle( {'font-size': '1.6rem'})
      expect(screen.getByRole('heading', {name: /Juju Soap/i})).toHaveStyleRule( 'width', '3rem' , {modifier: '::after'})
    }) 
